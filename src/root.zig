...
pub const ObjectReader = zova.ObjectReader;
pub const ObjectStorageProfile = zova.ObjectStorageProfile;
pub const ObjectPutOptions = zova.ObjectPutOptions;
pub const ObjectReaderError = zova.ObjectReaderError;
...
test "package exports zova database namespace" {
    ...
    try std.testing.expect(@hasDecl(@This(), "ObjectReader"));
    try std.testing.expect(@hasDecl(@This(), "ObjectStorageProfile"));
    try std.testing.expect(@hasDecl(@This(), "ObjectPutOptions"));
    try std.testing.expect(@hasDecl(@This(), "ObjectReaderError"));
    try std.testing.expect(@hasDecl(@This(), "objectChunkId"));
    try std.testing.expect(@hasDecl(@This(), "objectId"));
    ...
    try std.testing.expect(@hasDecl(Database, "putObjectChunkWithOptions"));
    try std.testing.expect(@hasDecl(Database, "assembleObjectFromChunks"));
    try std.testing.expect(@hasDecl(Database, "assembleObjectFromChunksWithOptions"));
    ...
    try std.testing.expect(@hasDecl(Database, "objectWriterWithOptions"));
    try std.testing.expect(@hasDecl(Database, "objectReader"));
    try std.testing.expect(@hasDecl(Database, "putObjectWithOptions"));
