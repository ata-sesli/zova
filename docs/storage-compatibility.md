...
| --- | --- | --- | --- |
| Package version | Zova release identity across every distribution channel | `src/version.zig` `package_version` | `1.0.0` |
| C ABI version | Compatibility of the exported C ABI and generated C | `src/version.zig` `abi_version_*` | `1.0.0` (`1.0.0` numeric components) |
