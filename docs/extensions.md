...
In the current v0.25.0 model, all installed extensions are required. Opening a
...
Zova supports three process-owned extension sources in v0.25.0:
...
The staged v0.25.0 integration model is the combination of app-defined scalar
...
In v0.25.0, the bundled `trgm` extension has a valid-subset salvage hook. When
...
## v0.25.0 Stability Limits

v0.25.0 retains the pre-1.0 extension-platform boundary: controlled scalar SQL
