...
In the current v1.0.0-rc.2 model, all installed extensions are required. Opening a
...
Zova supports three process-owned extension sources in v1.0.0-rc.2:
...
The staged v1.0.0-rc.2 integration model is the combination of app-defined scalar
...
newer than the host. The `1.0.0-rc.2` host reports numeric ABI `1.0.0`; extension
...
In v1.0.0-rc.2, the bundled `trgm` extension has a valid-subset salvage hook. When
...
## v1.0.0-rc.2 Stability Limits

v1.0.0-rc.2 establishes the 1.x extension-platform boundary: controlled scalar
