//! One bounded ingestion sample for issue #93; baseline vs borrowed variant in
//! alternating order. Usage: binary NEW_DATABASE_PATH deduplication|streaming SIZE_BYTES
