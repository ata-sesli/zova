...
example: scripts/build-release-artifacts.sh 0.21.1 macos-arm64 zig-out/artifacts
...
GENERATED_DIR="$TMP/zova-v$VERSION-generated-c"
...
GENERATED_ARCHIVE="$OUT_DIR/zova-v$VERSION-generated-c.tar.gz"
