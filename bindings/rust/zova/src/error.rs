...
impl Status {
    pub fn from_raw(code: i32) -> Self {
        match code {
            ...
            zova_sys::ZOVA_OBJECT_READER_CLOSED => Self::ObjectReaderClosed,
            zova_sys::ZOVA_BOUND_STORE_EXISTS => Self::BoundStoreExists,
            zova_sys::ZOVA_BOUND_STORE_NOT_FOUND => Self::BoundStoreNotFound,
            zova_sys::ZOVA_BOUND_STORE_INVALID => Self::BoundStoreInvalid,
    ...
    pub fn raw(self) -> i32 {
        match self {
            ...
            Self::ObjectReaderClosed => zova_sys::ZOVA_OBJECT_READER_CLOSED,
            Self::BoundStoreExists => zova_sys::ZOVA_BOUND_STORE_EXISTS,
            Self::BoundStoreNotFound => zova_sys::ZOVA_BOUND_STORE_NOT_FOUND,
            Self::BoundStoreInvalid => zova_sys::ZOVA_BOUND_STORE_INVALID,
