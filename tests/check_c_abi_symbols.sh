...
require_symbol zova_kv_get
require_symbol zova_kv_get_many
require_symbol zova_kv_put
require_symbol zova_kv_put_many
require_symbol zova_kv_delete
require_symbol zova_kv_delete_many
require_symbol zova_kv_count
require_symbol zova_kv_clear_namespace
require_symbol zova_kv_get_result_free
require_symbol zova_kv_get_many_results_free
...
require_symbol zova_database_probe_format
require_symbol zova_database_migrate
